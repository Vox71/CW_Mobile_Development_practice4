package ru.mirea.volkovma.thread;
...
import ru.mirea.volkovma.thread.databinding.ActivityMainBinding;
...
// Меняем имя и выводим в текстовом поле
        mainThread.setName("МОЙ НОМЕР ГРУППЫ: 7, НОМЕР ПО СПИСКУ: 1, МОЙ ЛЮБИИМЫЙ ФИЛЬМ: Драйв");
